...
All the parameters are statistically significant as the z-score excited 1.96 in absolute value.  
...
Yes the model is adequate.  The p-value for all different Ljung-Box tests are less than .05.  
...
Based on this ACF and PACF plots, there does not seem to be any inadequecies.  
...
I do believe the forecast seems a bit too wide.  The bottom end of the 95% CI goes as low as the lowest record unemployment recording in this data and as high as the highest.  