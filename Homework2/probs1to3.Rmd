...
Yesterday's Russell is a better forecast of Today's Russell. Where the Russell Index was yesterday is a strong indicator of where it will likely be today.  Therefore, we observe Yesterday's Russell as highly correlated to Today's Russell.  0.5 (Yesterday's Russell) under-estimates both the decreases and increases in the actual RI.  
...
Yes this results holds consistent with my findings in Problem 1.  Yesterday's Russell Index is highly correlated with Today's Russell Index as the coefficient value has an absolute value of 1.  
