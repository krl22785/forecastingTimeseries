...
library("ggplot") ## for data visualizations 
```
...
ggplot() + geom_line(aes(date, calls)) + xlab("2015") + ylab("Calls") + 
   labs(title = 'Housing Complaints to 311 in 2015') 
